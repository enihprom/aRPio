...
package types is
	...
	-- subtype nulx1_type is boolean range false .. false;
	...
	type int_natural is range 0 .. 2**32-1;
	for int_natural'size use 32;
	...
	type natural_2bit  is range 0 .. 2**2-1;
	for natural_2bit'size use 2;

	type natural_4bit  is range 0 .. 2**4-1;
	for natural_4bit'size use 4;
	...
	type buffer_bytes is array (positive range <>) of byte_natural;
	type buffer_bytes_256 is array (buffer_index) of byte_natural;
	--------------------------
